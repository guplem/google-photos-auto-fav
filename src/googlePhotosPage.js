/**
 * Everything this extension knows about the shape of Google Photos URLs.
 *
 * Google Photos ships obfuscated class names that change without warning, so
 * nothing here matches a class name. We only use URLs and link targets, which
 * are stable because the site needs them to work.
 */
 ...
 * The control panel only appears on those pages.
